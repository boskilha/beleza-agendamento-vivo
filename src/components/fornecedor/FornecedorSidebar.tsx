...
export function FornecedorSidebar() {
  ...
  return (
    <Sidebar className="bg-gradient-to-b from-purple-900 via-purple-800 to-purple-900 border-r border-purple-700/50">
      <SidebarContent className="bg-transparent">
        ...
        <div className="flex items-center justify-between p-4 border-b border-purple-700/50">
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div>
                <h1 className="font-serif text-xl font-bold text-white">Beleza Vivo</h1>
